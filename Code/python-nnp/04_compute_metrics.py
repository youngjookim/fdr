...
if __name__ == "__main__":
    ...
    for dataset in datasets:
        print(dataset)
        dirs = sorted(glob(data_dir + '/_sdr/{0}_*'.format(dataset)))
        ...
        for d in dirs:
            ...
            if D_high_train is None:
                ...
                D_high_train = compute_distance_memoized(X_train_orig_sdr, os.path.join(src_dataset_path, 'D_high_train.npy'))

            if D_high_test is None:
                print('Computing D_high_test')
                D_high_test = compute_distance_memoized(X_test_orig_sdr, os.path.join(src_dataset_path, 'D_high_test.npy'))
